...
extern int libuzfs_zpool_create(const char *zpool, const char *path, nvlist_t *props, nvlist_t *fsprops);
...
extern void libuzfs_zpool_prop_set(libuzfs_zpool_handle_t *zhp, zpool_prop_t prop, uint64_t value);
extern int libuzfs_zpool_prop_get(libuzfs_zpool_handle_t *zhp, zpool_prop_t prop, uint64_t *value);
...
extern int libuzfs_object_stat(libuzfs_dataset_handle_t *dhp, uint64_t obj, dmu_object_info_t *doi);
...
extern int libuzfs_object_read(libuzfs_dataset_handle_t* dhp, uint64_t obj, int offset, int size, char *buf);
extern int libuzfs_object_write(libuzfs_dataset_handle_t* dhp, uint64_t obj, int offset, int size, const char *buf);
