...
#define __GFP_MOVABLE	((gfp_t)___GFP_MOVABLE)  /* Page is movable */
...
#define __GFP_NOWARN	((gfp_t)___GFP_NOWARN)	/* Suppress page allocation failure warning */
...
#define __GFP_MEMALLOC	((gfp_t)___GFP_MEMALLOC)/* Allow access to emergency reserves */
#define __GFP_COMP	((gfp_t)___GFP_COMP)	/* Add compound page metadata */
#define __GFP_ZERO	((gfp_t)___GFP_ZERO)	/* Return zeroed page on success */
#define __GFP_NOMEMALLOC ((gfp_t)___GFP_NOMEMALLOC) /* Don't use emergency reserves.
							 * This takes precedence over the
							 * __GFP_MEMALLOC flag if both are
							 * set
							 */
#define __GFP_HARDWALL   ((gfp_t)___GFP_HARDWALL) /* Enforce hardwall cpuset memory allocs */
#define __GFP_THISNODE	((gfp_t)___GFP_THISNODE)/* No fallback, no policies */
#define __GFP_ACCOUNT	((gfp_t)___GFP_ACCOUNT)
#define __GFP_RECLAIMABLE ((gfp_t)___GFP_RECLAIMABLE) /* Page is reclaimable */
#define __GFP_NOTRACK	((gfp_t)___GFP_NOTRACK)  /* Don't track with kmemcheck */

#define __GFP_NO_KSWAPD	((gfp_t)___GFP_NO_KSWAPD)
#define __GFP_OTHER_NODE ((gfp_t)___GFP_OTHER_NODE) /* On behalf of other node */
#define __GFP_WRITE	((gfp_t)___GFP_WRITE)	/* Allocator intends to dirty page */
